      ...
      >
        <div className={s.header}>
          ...
          <div className={s.actions}>
            <button className={`${b.btn} ${b.square}`} onClick={onPrev}>&larr;</button>
            <button className={`${b.btn} ${b.square}`} onClick={onNext}>&rarr;</button>
            <button className={`${b.btn} ${b.square}`} onClick={onClose}>&times;</button>
          </div>
        </div>
